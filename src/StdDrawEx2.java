 ...
 * <a href =
 * "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">StdDrawEx2.java</a>
 ...
 * {@code StdDrawEx2.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 * that is NaN will behave as if it is outside the canvas, and will not be
 * visible.
...
public final class StdDrawEx2 implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	 ...
	 * {@code StdDrawEx2.DARK_GRAY}, {@code StdDrawEx2.GRAY},
	 * {@code StdDrawEx2.GREEN},
	 * {@code StdDrawEx2.LIGHT_GRAY}, {@code StdDrawEx2.MAGENTA},
	 * {@code StdDrawEx2.ORANGE},
	 * {@code StdDrawEx2.PINK}, {@code StdDrawEx2.RED}, {@code StdDrawEx2.WHITE},
	 * and
	...
	public void mouseClicked(MouseEvent e) {
		...
		yy = (int) y;
		if (Ex2Utils.Debug) {
			System.out.println("Mouse: " + xx + "," + yy);
		}
		// JTextField j= new JTextField(""+ix+","+iy+")",16);
		// j.setText("Enter");
		// j.setVisible(true);
		/*
		 * FileDialog chooser = new FileDialog(StdDrawEx2.frame,
		 * "Enter text to ("+ix+","+iy+")", FileDialog.SAVE);
		 * chooser.setVisible(true);
		 * String filename = chooser.getFile();
		 * if (filename != null) {
