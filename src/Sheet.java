...
/**
 * ArielU. Intro2CS, Ex2:
 * https://docs.google.com/document/d/1-18T-dj00apE4k1qmpXGOaqttxLn-Kwi/edit?usp=sharing&ouid=113711744349547563645&rtpof=true&sd=true
 * DO NOT CHANGE THIS INTERFACE:
 *
 * This interface represents a simple SpreadSheet, which include a 2D
 * array of Cells, with get & set methods for each cell (int x, int y), as well
 * as width, height of this SpreadSheet.
 * The main methods of the interface are:
 *
 * String eval(int x, int y), computes the actual String which should be
 * presented in the x, y cell.
 *
 * eval(), computes the actual 2D array of Strings which should be presented of
 * the SpreadSheet.
 *
 * int[][] depth(), computes a 2D array of the same dimension as this
 * SpreadSheet, each entry holds its dependency depth.
 */
public interface Sheet {
     ...
     * @return true iff the x, y coordinate is a valid entry (cell) with in this
     *         spreadsheet.
     */
    ...
    /**
     * Return the cell @ the coordinate (entry). E.g., the String "B3" will be
     * translated to [1][3].
     * 
     * @param entry
     * @return the cell at the X.Y coordinate, or null if cords is an illegal
     *         coordinate or is out of this SprayedSheet.
     */
    ...
    /**
     * Computes a 2D array of the same dimension as this SpreadSheet, each entry
     * holds its dependency depth.
   ...
   public int[][] depth();
     ...
     * You can assume that the width and the height of the loaded SpreadSheet are as
     * defined in
     ...
     *
     * E.g.,
     * I2CS ArielU: SpreadSheet (Ex2) assignment - this line should be ignored in
     * the load method
     * 0,0,1
     * 0,1,=2+a0
     ...
     *
     * @param fileName a String representing the full (an absolute or relative path
     *                 tp the saved file).
     * @throws IOException an exception might be throed if the flie can not be
     *                     saved.
     */
     ...
     * @param fileName a String representing the full (an absolute or relative path
     *                 to the loaded file).
     * @throws IOException an exception might be throed if the file can not be
     *                     loaded.
     */
